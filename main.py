...
# word list
wordList = ['jump', 'game', 'python', 'pygame', 'play', 'coding', 'time', 'random', 'words', 'word', 'score', 'player',
            'lost', 'won', 'develop', 'jumpGame', 'project', 'code','python']
...
def displayScreen():
    ...
    if gamenotover is False:
        ...
        putText(150, 200, "Game Over", 100)
        # displaying final score
        putText(290, 380, "Score: " + str(score), 50)

    # if game is not over
    else:
        putText(100, 250, "Press Any Key to Start Playing!", 50)
